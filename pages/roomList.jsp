...
<c:if test="${use != null}" >
<div align="right"><table><tr><td> <spring:url  value="/secure/logout" var="fetchUrl"  > </spring:url> <a href = "${fetchUrl}" > Logout </a>                                                  </td></tr>
<tr><td><p><br/></p></td></tr>
<tr><td><p><br/></p></td></tr>
</table></div>
</c:if>
...
<tr>
            <spring:url value="/secure/allocateRooms"
			var="allocateUrl">
			<spring:param name="roomNumber" value="${o.roomNumber}">
            </spring:param>
			</spring:url >	
<spring:url value="/secure/deallocateRooms"
			var="deallocateUrl">
			<spring:param name="roomNumber" value="${o.roomNumber}">
            </spring:param>
			</spring:url >
...
<spring:url value="/back" var="fetchUrl"  /> <a href="${fetchUrl}" > Back </a>
